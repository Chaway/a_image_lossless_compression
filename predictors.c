...
{ 
  ...
  char filename[] = "pre1.raw";
   ...
   for(int i = 1 ; i < rows;i++)
    ...
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
    //fwrite(&T[0][0],sizeof(T[0][0]),1,fp_code);
    
    //printf("image[0][0] = %d\n",image[0][0]);
    printf("predictor1:Pre-processing1 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
    //printf("%d\n",ftell(fp_code));
    min_code_length = code_length;
    printf("Arithmetic code stream length is %d bytes -> Compression rate is %f\n",code_length,num_pixels/(code_length + total + 0.0));
    best_pre = 1;
    fclose(fp_code);
}
 ...
 void prediction2()
 {
  ...
  int dif_temp;
   ...
   for(int i = 0 ; i < rows;i++)
    ...
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
    //printf("image[0][0] = %d\n",image[0][0]);
    printf("predictor2:Pre-processing2 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
    printf("Arithmetic code stream length is %d bytes -> Compression rate is %f\n",code_length,num_pixels/(code_length + total + 0.0));
    //printf("%d\n",ftell(fp_code));
    //min_code_length = code_length;
 ...
 void prediction3()
 {
  ...
  char * filename = "pre3.raw";
   ...
   for(int i = 1 ; i < rows;i++)
    ...
    //printf("image[0][0] = %d\n",image[0][0]);
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
     printf("predictor3:Pre-processing3 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
    //printf("%d\n",ftell(fp_code));
    //min_code_length = code_length;
    printf("Arithmetic code stream length is %d bytes -> Compression rate is %f\n",code_length,num_pixels/(code_length + total + 0.0));
  ...
  void prediction4()
 {
  ...
  if(fpo == NULL)
  {
   ...
   for(int i = 1 ; i < rows;i++)
    ...
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
    //printf("image[0][0] = %d\n",image[0][0]);
   printf("predictor4:Pre-processing4 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
    printf("Arithmetic code stream length is %d bytes -> Compression rate is %f\n",code_length,num_pixels/(code_length + total + 0.0));
    //printf("%d\n",ftell(fp_code));
    //min_code_length = code_length;
   ...
   void prediction5()
 {
  ...
  if(fpo == NULL)
  {
   ...
   for(int i = 1 ; i < rows;i++)
    ...
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
    //printf("image[0][0] = %d\n",image[0][0]);
    printf("predictor5:Pre-processing5 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
    //printf("%d\n",ftell(fp_code));
    //min_code_length = code_length;
    printf("Arithmetic code stream length is %d bytes -> Compression rate is %f\n",code_length,num_pixels/(code_length + total + 0.0));
  ...
  void prediction6()
 {
  ...
  if(fpo == NULL)
  {
   ...
   for(int i = 1 ; i < rows;i++)
    ...
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
    //printf("image[0][0] = %d\n",image[0][0]);
  printf("predictor6:Pre-processing6 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
    printf("Arithmetic code stream length is %d bytes -> Compression rate is %f\n",code_length,num_pixels/(code_length + total + 0.0));
    //printf("%d\n",ftell(fp_code));
    //min_code_length = code_length;
  ...
  void prediction7()
 {
  ...
  if(fpo == NULL)
  {
   ...
   for(int i = 1 ; i < rows;i++)
    ...
    fwrite(&max,sizeof(max),1,fp_code);
    int total = sizeof(preclass) + sizeof(image[0][0]) + sizeof(min) + sizeof(max);
    printf("predictor7:Pre-processing7 -> arithmetic coding start -> ");
    int code_length =  arith_code(filename,fp_code);
